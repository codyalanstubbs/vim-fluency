...
let s:expected = [
  ...
  \ {'id': 'move_single_char_up_down_left_right', 'prereqs': ['switch_mode_to_insert', 'insert_basic']},
  \ {'id': 'move_to_line_edges_all', 'prereqs': ['switch_mode_to_insert', 'insert_basic']},
  \ {'id': 'move_single_char_left_right', 'prereqs': ['switch_mode_to_insert', 'insert_basic']},
  \ {'id': 'move_single_char_up_down', 'prereqs': ['switch_mode_to_insert', 'insert_basic']},
  \ {'id': 'move_to_line_edges_beginning_end', 'prereqs': ['switch_mode_to_insert', 'insert_basic']},
  ...
  \ {'id': 'discriminate_delete_char_vs_line',  'prereqs': ['switch_mode_to_insert', 'insert_basic']},
  \ {'id': 'discriminate_indent_vs_dedent',  'prereqs': ['switch_mode_to_insert', 'insert_basic']},
  \ {'id': 'recall_inner_quote_pair', 'prereqs': ['switch_mode_to_insert', 'insert_basic']},
