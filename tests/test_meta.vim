...
let s:expected = [
  ...
  \ {'id': 'change_current_mode', 'prereqs': []},
  \ {'id': 'move_single_char_up_down_left_right', 'prereqs': ['change_current_mode', 'insert_basic']},
  \ {'id': 'move_to_line_edges_all', 'prereqs': ['change_current_mode', 'insert_basic']},
  \ {'id': 'move_single_char_left_right', 'prereqs': ['change_current_mode', 'insert_basic']},
  \ {'id': 'move_single_char_up_down', 'prereqs': ['change_current_mode', 'insert_basic']},
  \ {'id': 'move_to_line_edges_beginning_end', 'prereqs': ['change_current_mode', 'insert_basic']},
  ...
  \ {'id': 'discriminate_delete_char_vs_line',  'prereqs': ['change_current_mode', 'insert_basic']},
  \ {'id': 'discriminate_indent_vs_dedent',  'prereqs': ['change_current_mode', 'insert_basic']},
  \ {'id': 'recall_inner_quote_pair', 'prereqs': ['change_current_mode', 'insert_basic']},
