...
let s:expected = [
  ...
  \ {'id': 'move_repeat_last_till_backward', 'prereqs': ['move_repeat_last_till_forward', 'move_till_char_forward_backward']},
  ...
  \ {'id': 'move_repeat_last_find_backward', 'prereqs': ['move_repeat_last_find_forward', 'move_to_char_forward_backward']},
