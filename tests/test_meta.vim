...
let s:expected = [
  ...
  \ {'id': 'move_single_char_up_down_left_right', 'prereqs': ['switch_mode_to_insert', 'insert_before_after_char_start_end_line']},
  \ {'id': 'move_to_line_edges_all', 'prereqs': ['switch_mode_to_insert', 'insert_before_after_char_start_end_line']},
  \ {'id': 'move_single_char_left_right', 'prereqs': ['switch_mode_to_insert', 'insert_before_after_char_start_end_line']},
  \ {'id': 'move_single_char_up_down', 'prereqs': ['switch_mode_to_insert', 'insert_before_after_char_start_end_line']},
  \ {'id': 'move_to_line_edges_beginning_end', 'prereqs': ['switch_mode_to_insert', 'insert_before_after_char_start_end_line']},
  ...
  \ {'id': 'discriminate_delete_char_vs_line',  'prereqs': ['switch_mode_to_insert', 'insert_before_after_char_start_end_line']},
