...
- **Seven pinpoints shipped** (1A.1 hjkl, 1A.2 line start/end, 1B.1 word motions, 1C.1 find char, 1C.2 till char, 1C.3 repeat last find, 4.d delete with word motion). See `CATALOG.md` for the planned ~80.
- **Vim 8.1+** required.
