...
function! vimfluency#pinpoints#visual_select_single_char_left_right#meta() abort
...
function! vimfluency#pinpoints#visual_select_single_char_left_right#lesson() abort
...
function! vimfluency#pinpoints#visual_select_single_char_left_right#generate() abort
  let line_len = 20
  let n_lines = 7
  let lines = []
