" move_single_char_up_down — j vs k. Narrower 2-cell sibling of 1A.1 (hjkl). Shared
" quality: single-line vertical motion. Juxtaposed quality: direction
" (down vs up). Fallback for learners who plateau on 1A.1 on the
" vertical axis.
"
" Design constraints:
...
function! vimfluency#pinpoints#move_single_char_up_down#meta() abort
  return {'id': 'move_single_char_up_down', 'name': 'j k', 'aim': 60,
    ...
    \ 'narrower_of': 'move_single_char_up_down_left_right', 'parallel_to': ['move_single_char_left_right'], 'family': 'motion'}
endfunction

function! vimfluency#pinpoints#move_single_char_up_down#lesson() abort
...
function! vimfluency#pinpoints#move_single_char_up_down#generate() abort
  let line_len = 20
  let n_lines = 7
  let lines = []
