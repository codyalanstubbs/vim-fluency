...
function! vimfluency#pinpoints#visual_select_single_char_up_down#meta() abort
...
function! vimfluency#pinpoints#visual_select_single_char_up_down#lesson() abort
...
function! vimfluency#pinpoints#visual_select_single_char_up_down#generate() abort
  let line_len = 20
  let n_lines = 7
  let lines = []
