...
"
" Compared to the four atomic switch_mode_to_X pinpoints, this drill
...
" target — same code path as the atomic switch_mode_to_X pinpoints.
...
" Kept inline so the pinpoint doesn't reach into runner internals.
