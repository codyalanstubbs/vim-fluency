" 4.3 — delete to line edge (d0, d$). Composite-behavior pinpoint
...
function! vimfluency#pinpoints#p4_3#generate() abort
...
function! vimfluency#pinpoints#p4_3#lesson() abort
