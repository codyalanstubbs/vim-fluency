...
" natural home in a future visual-family drill.

let s:targets = ['n', 'v']

function! vimfluency#drills#switch_mode_to_visual#meta() abort
...
function! vimfluency#drills#switch_mode_to_visual#generate() abort
...
function! vimfluency#drills#switch_mode_to_visual#lesson() abort
  return [
