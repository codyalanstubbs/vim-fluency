...
" change_current_mode drill with a tight 2-cell drill per the
" slice-01 exhaustive-hierarchy framework — each atomic mode-pair
" gets its own drill. Between-non-Normal transitions live in
" switch_between_many_modes (composite).
"
" Cells:
...
function! vimfluency#drills#switch_mode_to_insert#generate() abort
...
function! vimfluency#drills#switch_mode_to_insert#lesson() abort
  return [
