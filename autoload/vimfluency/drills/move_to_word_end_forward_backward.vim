...
" this drill the discrimination is direction (forward / backward),
...
" drill instead of bundling with w/b.
"
...
function! vimfluency#drills#move_to_word_end_forward_backward#meta() abort
...
function! vimfluency#drills#move_to_word_end_forward_backward#generate() abort
  let n_words = 10
  let words = []
