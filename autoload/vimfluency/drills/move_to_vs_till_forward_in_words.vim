...
function! vimfluency#drills#move_to_vs_till_forward_in_words#meta() abort
...
function! vimfluency#drills#move_to_vs_till_forward_in_words#generate() abort
  let attempts = 0
  while attempts < 30
    let attempts += 1
...
function! vimfluency#drills#move_to_vs_till_forward_in_words#lesson() abort
