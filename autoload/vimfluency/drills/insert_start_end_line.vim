...
function! vimfluency#drills#insert_start_end_line#meta() abort
...
function! vimfluency#drills#insert_start_end_line#generate() abort
...
function! vimfluency#drills#insert_start_end_line#lesson() abort
  ...
  return [
    ...
    \  'prompt': [
    \    'Two insert-entry keys, by line edge:',
    \    '',
    \    '    I   →   opens INSERT at the first non-blank (line start)',
    \    '    A   →   opens INSERT at the end of the line',
    \    '',
    \    'Neither cares where the cursor starts — both jump to their edge first.',
    \    '',
    \    printf('Press the key, then type %s.', t),
    \    '',
