...
function! vimfluency#drills#move_repeat_last_find_backward#lesson() abort
  ...
  return [
    ...
    \  'prompt': [
    \    'F{char} searches BACKWARD and lands ON the previous match.',
    \    '; and , repeat it — no retyping the char:',
    \    '',
    \    '    ;  repeats backward again (onto the previous match)',
    ...
    \  'waypoints': [[1, 10]],
    \  'prompt': 'Both s''s are behind you. Press Fs (lands on the nearer s, col 10 = 1), then ; (jumps back onto the first s, col 4 = 2).'},
    \ {'kind': 'try', 'lines': buf1, 'start': [1, 7], 'target': [1, 10],
    \  'waypoints': [[1, 4]],
    \  'prompt': 'You sit between the s''s. Press Fs (lands back on the first, col 4 = 1), then , (reverses forward onto the second s, col 10 = 2).'},
    \ {'kind': 'try', 'lines': buf1, 'start': [1, 12], 'target': [1, 4],
    \  'waypoints': [[1, 10]],
