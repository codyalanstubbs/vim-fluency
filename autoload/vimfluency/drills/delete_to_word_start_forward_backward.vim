...
function! vimfluency#drills#delete_to_word_start_forward_backward#meta() abort
  return {'id': 'delete_to_word_start_forward_backward', 'name': 'delete with word motion (dw / db)',
    ...
    \ 'parallel_to': ['delete_to_line_edges_start_end', 'delete_single_char_left_right'], 'keys': 'dw/db', 'family': 'delete',
    \ 'test_sequence': ['dw', 'db']}
endfunction
...
function! vimfluency#drills#delete_to_word_start_forward_backward#generate() abort
  let n_words = 5
  let words = []
  let used = {}
...
function! vimfluency#drills#delete_to_word_start_forward_backward#lesson() abort
  ...
  return [
    ...
    \  'expected_motion': 'db', 'optimal_motions': 1,
