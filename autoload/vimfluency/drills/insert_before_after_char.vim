...
function! vimfluency#drills#insert_before_after_char#meta() abort
...
function! vimfluency#drills#insert_before_after_char#generate() abort
...
function! vimfluency#drills#insert_before_after_char#lesson() abort
  ...
  return [
    ...
    \  'prompt': [
    \    'Two insert-entry keys:',
    \    '',
    \    '    i   →   opens INSERT before the cursor',
    \    '    a   →   opens INSERT after the cursor',
    \    '',
    \    printf('Press the key, then type %s; it advances the moment the text appears.', t),
    \    '',
