...
" minimal-pair-drill principle while staying inside tier 2's
...
function! vimfluency#drills#delete_char_vs_line#meta() abort
...
function! vimfluency#drills#delete_char_vs_line#generate() abort
...
function! vimfluency#drills#delete_char_vs_line#lesson() abort
  ...
  return [
    ...
    \  'expected_motion': 'x', 'optimal_motions': 1,
    ...
    \  'expected_motion': 'dd', 'optimal_motions': 1,
