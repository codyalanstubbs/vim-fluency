<!-- For pinpoint PRs, fill the checklist. For bug fixes / docs, delete it and describe the change. -->

## What

<!-- One paragraph: what this adds or fixes. Link the proposal issue for pinpoints. -->
...
- [ ] Cheat analysis documented as a comment block at the top of the pinpoint file
