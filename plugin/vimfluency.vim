" vimfluency — fluency training runner for vim drills
...
command! -nargs=? -complete=customlist,vimfluency#complete Vf call vimfluency#dashboard(<f-args>)
command! -nargs=* -complete=customlist,vimfluency#complete VfTrain call vimfluency#start(<f-args>)
command! -nargs=* -complete=customlist,vimfluency#complete VfDemo call vimfluency#demo(<f-args>)
...
command! -nargs=1 -complete=customlist,vimfluency#complete VfLearnDemo call vimfluency#learn_demo(<f-args>)
...
command! -nargs=+ -complete=customlist,vimfluency#complete_path VfSetPath call vimfluency#set_path(<q-args>)
command! VfResetPath call vimfluency#reset_path()
command! VfPaths call vimfluency#list_paths()
