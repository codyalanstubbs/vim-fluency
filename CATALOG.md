...
| `delete_inside_pairs` | delete inside quotes/brackets (di" / di( / di{ / di[) | `di"/di(/di{/di[` | `editing` | 55 | `delete_inside_around_tag` |
...
_51 drills across 6 families. Regenerate with `scripts/gen-catalog.sh`._
